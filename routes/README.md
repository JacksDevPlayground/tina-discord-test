...
| ----- | ---- | ---- | ---- |
| `/` | - | `Home` | `<Home.Link>` |
| `/posts/[filename]` | - | `PostsFilename` | `<PostsFilename.Link>` |
...
- [ ] `/posts/[filename]/page.info.ts`: Add search typing to if the page supports search paramaters
- [ ] Convert `Link` components for `/posts/[filename]` to `<PostsFilename.Link>`
- [ ] Convert `params` typing in `/posts/[filename]/page.ts` to `z.infer<>`
